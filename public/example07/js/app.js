...
(function (app) {
    ...
    var DatabaseModel = (function () {
        ...
        DatabaseModel.prototype.getHeroData = function () {
            var _this = this;
            var self = this;
            this.loadStartFunc();
            if(this.debug) {
                var data = [
                    {
                        ...
                        "like": "熱帯魚",
                        "hate": "ゴキブリ",
                        "desc": "本作の主人公。屈強な体格と逆立たてた黒髪といういでたちの大柄な青年。正義感が強く、争い事は好まない。15歳の時に奈々緒が義父から虐待を受けている最中に出くわし、助けようと素手で殴り殺したため少年刑務所へ入所させられる。出所後、奈々緒の後を追いバグズ手術を受ける。",
                        "imgUrl": ""
                    }, 
                    {
                        "id": "1",
                    ...
                    }, 
                    {
                        ...
                        "like": "鍋料理・家族",
                        "hate": "左記以外のほぼ全て",
                        "desc": "肌が荒れ、醜い顔をしている。一見、肥満体のようだが、非常に屈強な肉体と強靭な精神力、更に優れた頭脳の持ち主。11人兄弟の長男であり、年の離れた幼い弟妹（弟6人、妹4人）を養うためにバグズ計画に参加した。病に臥した母の願いから一流大学を目指し、いじめも意に介さず勉学に励んだ結果、大学に受かるものの、なにかと自分を気にかけてくれた男性教師から女子生徒を妊娠させた事件のスケープゴートにされ、大学合格取り消しと退学処分を受けた。",
                        "imgUrl": ""
                    }, 
                    {
                        "id": "3",
                    ...
                    }, 
                    {
                        ...
                        "like": "ニール・アームストロング",
                        "hate": "納豆",
                        "desc": "宇宙飛行士を目指していたが、母親には事故死したと聞かされていた父親[5]が実際は過去にU-NASAへ反逆して死刑になっており、その道を閉ざされる。その後、「参加すれば宇宙へ行ける」バグズ計画に参加した。乗組員全員の事情と能力を一応把握しており、乗組員の中で唯一、バグズ1号が知的生命体により攻撃を受けた可能性があることを伝えられていた。薬の使用により両腕が異常に太く発達する。腕力、耐久力はテラフォーマー以上であり、怪力を活かしてて戦う。バグズ2号艦内へ自ら数多くのテラフォーマーを引き付け、味方に酸素を遮断させて殲滅する。酸欠で意識不明になり倒れていた所を、ウッドの裏切りにより銃殺される。オールバック風の髪型に顎鬚を蓄えている。",
                        "imgUrl": ""
                    }, 
                    {
                        "id": "5",
